...
export const THEME_TEMPLATES: ThemeTemplate[] = [
  {
    id: 'bazaar',
    name: 'Bazaar — Ethnic Luxury',
    description: 'Warm earthy palette with editorial serif headings. Best for ethnic, jewellery, handcrafted brands.',
    category: 'elegant',
    isPremium: false,
    price: 0,
    colors: {
  ...
  },
  {
    id: 'marketplace',
    name: 'Marketplace',
    description: 'Bright, dense product grid with bold CTAs. Best for multi-category catalogues.',
    category: 'bold',
    isPremium: false,
    price: 0,
    colors: {
    ...
    layout: 'grid',
    borderRadius: 8,
    preview: { heroStyle: 'full-width', productCardStyle: 'simple', navStyle: 'top' },
  },
  {
    id: 'minimal-light',
    name: 'Minimal Light',
