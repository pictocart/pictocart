      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        >
          ...
          <div className="space-y-4">
            {/* Eligibility banner */}
            <div className="flex items-start gap-2 rounded-md p-3 text-xs border" style={{ background: "var(--surface, rgba(0,0,0,0.03))", borderColor: "var(--border, #e5e7eb)" }}>
            ...
            {items.length > 1 && (
              <div className="space-y-2">
                ...
                <select 
                  ...
                  style={{ background: "var(--bg, #ffffff)", color: "var(--fg, #111827)", borderColor: "var(--border, #e5e7eb)" }}
                >
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {images.map((u, i) => (
                  <div key={i} className="relative h-16 w-16 rounded-md overflow-hidden border" style={{ borderColor: "var(--border, #e5e7eb)" }}>
                ...
                {images.length < 5 && (
                  <label className="h-16 w-16 border-2 border-dashed rounded-md flex items-center justify-center cursor-pointer" style={{ borderColor: "var(--border, #e5e7eb)", background: "var(--surface, rgba(0,0,0,0.03))", color: "var(--fg, #111827)" }}>
            ...
            <div className="flex justify-end gap-2 pt-2">
              <Button variant="outline" onClick={() => setOpen(false)} style={{ color: "var(--fg, #111827)", borderColor: "var(--border, #e5e7eb)", background: "transparent" }}>Cancel</Button>
