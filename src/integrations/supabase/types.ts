  ...
  public: {
    Tables: {
      ...
      partner_hidden_demo_shops: {
        ...
        Relationships: [
          {
            foreignKeyName: "partner_hidden_demo_shops_demo_shop_id_fkey"
            columns: ["demo_shop_id"]
            isOneToOne: false
            referencedRelation: "partner_demo_shops"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "partner_hidden_demo_shops_partner_id_fkey"
            columns: ["partner_id"]
            isOneToOne: false
      ...
      store_assistance_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_assistance_requests_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
      ...
      store_secrets: {
        Row: {
          ...
          razorpay_domain_verified: boolean
      ...
      store_theme_snapshots: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_theme_snapshots_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      allocate_partner_licenses:
        | { Args: { _partner_id: string }; Returns: undefined }
        | {
            Args: {
              _partner_id: string
              _qty_basic: number
      ...
      cancel_unpaid_order: { Args: { _order_id: string }; Returns: undefined }
      check_email_exists: {
        Args: { p_email: string; p_exclude_user_id?: string }
        Returns: boolean
      }
      check_employee_id_exists: {
        Args: { p_employee_id: string; p_exclude_staff_id?: string }
        Returns: boolean
      }
      configure_demo_shop: { Args: { _shop_email: string }; Returns: undefined }
      consume_credits: {
      ...
      delete_store_staff_member: { Args: { p_staff_id: string }; Returns: Json }
      ...
      get_visible_demo_shops_for_partner: {
        Args: { _partner_id: string }
        Returns: {
          category: string
          created_at: string
      ...
      redeem_partner_one_time_code: {
        Args: { _code: string; _partner_id: string }
        Returns: number
      }
      resolve_partner_by_referral_code: {
