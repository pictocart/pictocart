...
export const RETURN_STATUSES: { value: ReturnStatus; label: string; color: string }[] = [
  ...
  { value: 'picked_up',             label: 'Picked Up / In Transit to Store', color: 'bg-indigo-100 text-indigo-800 border-indigo-200' },
  ...
  { value: 'received',              label: 'Delivered to Warehouse/Store', color: 'bg-purple-100 text-purple-800 border-purple-200' },
