                            ...
                            <div className="flex items-start justify-between gap-3 mb-4 flex-wrap pb-3 border-b border-dashed" style={{ borderColor: colors.secondary }}>
                              ...
                              <div className="flex flex-col items-end gap-1.5">
                                ...
                                {order.payment_status && (
                                  <span 
                                    ...
                                    style={{ 
                                      backgroundColor: (
                                        ...
                                        order.payment_status === 'refund_requested' ? '#7c3aed' : 
                                        order.payment_status === 'refund_in_process' ? '#3b82f6' : 
                                        '#f59e0b'
                                      ) + '10', 
                                      color: 
                                        order.payment_status === 'paid' ? '#16a34a' : 
                                  ...
                                  >
                                    {order.payment_status === 'refund_requested' ? 'Refund Requested' : 
                                     order.payment_status === 'refund_in_process' ? 'Refund in Process' : 
                                     order.payment_status}
                                  </span>
                                )}
                              </div>
