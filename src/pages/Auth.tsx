...
const Auth = () => {
  ...
  // Reset loading state when the page is shown (e.g., when returning via browser Back button)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (s) s.remove();
      const wrapper = document.getElementById("credential_picker_container");
            ...
            <>
              ...
              {isGoogleConfigured ? (
                ...
                <Button
                  ...
                  disabled={loading}
                  onClick={() => {
                    toast.info('Please set VITE_GOOGLE_CLIENT_ID in your .env file to enable Google Login.');
                  }}
                >
