  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        usps: { type: "array", items: { type: "object", properties: { icon: { type: "string" }, title: { type: "string" }, sub: { type: "string" } }, required: ["icon","title","sub"] } },
        categories: { type: "array", items: { type: "object", properties: { name: { type: "string" }, image_prompt: { type: "string" } }, required: ["name","image_prompt"] } },
        products: { type: "array", items: { type: "object", properties: { name: { type: "string" }, price: { type: "number" }, compare_at: { type: "number" }, badge: { type: "string" } }, required: ["name","price","compare_at","badge"] } },
        story: { type: "object", properties: { title: { type: "string" }, body: { type: "string" } }, required: ["title","body"] },
        testimonials: { type: "array", items: { type: "object", properties: { quote: { type: "string" }, author: { type: "string" }, location: { type: "string" } }, required: ["quote","author","location"] } },
        newsletter: { type: "object", properties: { title: { type: "string" }, sub: { type: "string" }, cta: { type: "string" } }, required: ["title","sub","cta"] },
        footer: { type: "object", properties: { tagline: { type: "string" }, columns: { type: "array", items: { type: "object", properties: { title: { type: "string" }, links: { type: "array", items: { type: "string" } } }, required: ["title","links"] } } }, required: ["tagline","columns"] },
        about: { type: "object", properties: { title: { type: "string" }, mission: { type: "string" }, values: { type: "array", items: { type: "string" } } }, required: ["title","mission","values"] },
        layout: {
          type: "object",
          properties: {
            hero_style: { type: "string" },
            category_style: { type: "string" },
  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        usps: { type: "array", items: { type: "object", properties: { icon: { type: "string" }, title: { type: "string" }, sub: { type: "string" } }, required: ["icon","title","sub"] } },
        departments: { type: "array", description: "Departments / specialities (Cardiology, Hair, Bridal, etc.)", items: { type: "object", properties: { name: { type: "string" }, image_prompt: { type: "string" } }, required: ["name","image_prompt"] } },
        providers: {
          type: "array",
          items: {
            type: "object",
        ...
        clinic_hours: {
          ...
          properties: {
            ...
            hours: { type: "array", items: { type: "object", properties: { day: { type: "string" }, open: { type: "string" }, close: { type: "string" }, closed: { type: "boolean" } }, required: ["day","open","close","closed"] } },
          },
          required: ["title","address","phone","note","hours"],
        },
