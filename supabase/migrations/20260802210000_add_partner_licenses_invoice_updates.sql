-- 1. Redefine apply_partner_license_key to activate subscriptions for 1 year (instead of 30 days)
...
BEGIN
  ...
  -- Insert/Update subscription for 1 year
  INSERT INTO public.subscriptions (store_id, plan, status, current_period_end)
  VALUES (_store_id, target_plan::subscription_plan, 'active', now() + interval '1 year')
